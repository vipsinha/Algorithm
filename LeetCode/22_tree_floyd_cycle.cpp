...
// watch this video for explanation: https://www.youtube.com/watch?v=RKr9yw1LPNk
...
class Solution {
public:
    bool hasCycle(ListNode* head) { return floyd_cycle(head); }

    bool floyd_cycle(ListNode* head) {
        ListNode* slow = head;
        ListNode* fast = head;
